  ...
  return (
    <div className="space-y-6 p-4 lg:p-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                articulos
                  .filter(
                    (a) =>
                      ...
                      ) || String(a.ArticuloID).includes(busqueda)
                  )
                  .map((a) => (
                    <div
                      key={a.ArticuloID}
        ...
        {/* DERECHA: Formulario de facturación */}
        <div>
          <Card className="p-4 lg:p-6 space-y-4">
                    ...
                    <tr key={i.key} className="border-b border-border">
                      ...
                      <td className="py-2 px-2 text-right">
                        <Input
                          ...
                          value={i.Cantidad}
                          onChange={(e) =>
                            cambiarCantidad(i.key, Number(e.target.value) || 0)
                          }
                        />
                      </td>
                ...
                >
                  ...
                  <td className="py-2 px-2 text-center">
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => verDetalle(f.FacturaID)}
                    >
                      Ver Detalle
                    </Button>
                  </td>
      ...
      <Dialog open={openDetalle} onOpenChange={setOpenDetalle}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              Detalle de Factura #{facturaSeleccionada?.FacturaID}
            </DialogTitle>
          </DialogHeader>
          {facturaSeleccionada && (
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {new Date(facturaSeleccionada.Fecha).toLocaleString()}
                  </p>
                </div>
                <div>
                  <Label className="text-muted-foreground">Comentario</Label>
                  <p className="font-medium">
                    {facturaSeleccionada.Comentario || "Sin comentarios"}
                  </p>
                </div>
              </div>
