...
const recentInvoices = [
  { id: "FAC-001", client: "Empresa ABC", amount: 15000, date: "2025-01-28", status: "Pagada" },
  { id: "FAC-002", client: "Comercial XYZ", amount: 8500, date: "2025-01-27", status: "Pendiente" },
  { id: "FAC-003", client: "Distribuidora 123", amount: 22000, date: "2025-01-26", status: "Pagada" },
  { id: "FAC-004", client: "Servicios Pro", amount: 12500, date: "2025-01-25", status: "Vencida" },
]
...
export default function DashboardPage() {
  return (
    <div className="space-y-6 p-4 lg:p-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl lg:text-3xl font-bold text-foreground">Panel de Control</h1>
        <p className="text-muted-foreground mt-1">Resumen general de su negocio</p>
      </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center gap-1 mt-2">
                ...
                <span className="text-sm text-destructive font-medium">-2.3%</span>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="p-6">
          <h3 className="text-lg font-semibold text-foreground mb-4">Ventas vs Compras</h3>
        ...
        <Card className="p-6">
          <h3 className="text-lg font-semibold text-foreground mb-4">Tendencia de Ventas</h3>
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={salesData}>
              ...
              />
              <Line type="monotone" dataKey="ventas" stroke="hsl(var(--chart-1))" strokeWidth={3} />
            </LineChart>
          </ResponsiveContainer>
        </Card>
      </div>
      ...
      <Card className="p-6">
        <h3 className="text-lg font-semibold text-foreground mb-4">Facturas Recientes</h3>
            ...
            <tbody>
              {recentInvoices.map((invoice) => (
                <tr key={invoice.id} className="border-b border-border hover:bg-muted/50 transition-colors">
                  ...
                  <td className="py-3 px-4 text-sm text-muted-foreground hidden sm:table-cell">{invoice.date}</td>
